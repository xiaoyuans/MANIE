...
fidout=fopen('Result_karate_model_3_undirected_uncircle.txt','w');
...
[list,cost,FPR,TPR,AUC]=reconstruct(MODEL{3},NODE,BASIS{i},ORDER,connectivity,ts_param,data,th);
